        ...
        <div className="form-section">
          ...
          <form>
            <div className="form-group">
              ...
              <p className="help-text">Para ayudar a las personas a descubrir tu cuenta...</p>
            </div>

            <div className="form-group">
              <label>Nombre de usuario</label>
              <input type="text" value="paulisortize" />
              <p className="help-text">En la mayoría de los casos, podrás volver a cambiarlo...</p>
            </div>
            ...
            <p className="help-text">Proporciona tu información personal...</p>
      ...
      {activeTab === 'contraseña' && (
        <div className="form-section">
          ...
          <form>
            ...
            <div className="form-group">
              <label>Re escribe la nueva contraseña</label>
              <input type="password" />
            </div>
